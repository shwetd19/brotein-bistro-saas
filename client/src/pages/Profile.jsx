...
export default function Profile() {
  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-login pt-10">
      ...
      request.resource.contentType.matches('image/.*') */}
          ...
          <input
            ...
            onChange={handleChange}
          />
          <button className="w-full p-2 border border-gray-300 shadow-sm rounded-md mt-1  px-6 py-2 text-sm font-medium hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500">
